...
g = datetime.datetime(2023, 10, 23, 14, 0, 0)
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s{\033[1;33m [𝐘𝐀𝐒𝐈𝐑🜧] %s/%s ➙ \033[1;95m[ [𝐓𝐑𝐔𝐄]] %s ➙\033[1;31m [ [𝐁𝐋𝐎𝐂𝐊]] %s .. } %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
